...
dateAxis.renderer.labels.template.fill = am4core.color("#7a7da0");
...
valueAxis.renderer.gridContainer.background.fill = am4core.color("rgba(0,0,0,0)");
valueAxis.renderer.gridContainer.background.fillOpacity = 0;
valueAxis.renderer.inside = true;
valueAxis.renderer.labels.template.verticalCenter = "bottom";
valueAxis.renderer.labels.template.padding(2, 2, 2, 2);
valueAxis.renderer.labels.template.fill = am4core.color("#7a7da0");
